...
export enum EmailType {
  ...
  COMMISSION_L1_APPROVED_NOTIFY = "COMMISSION_L1_APPROVED_NOTIFY",
  COMMISSION_L1_REJECTED_NOTIFY = "COMMISSION_L1_REJECTED_NOTIFY",
  COMMISSION_L2_APPROVED_NOTIFY = "COMMISSION_L2_APPROVED_NOTIFY",
  COMMISSION_L2_REJECTED_TO_L1_NOTIFY = "COMMISSION_L2_REJECTED_TO_L1_NOTIFY",
  COMMISSION_L2_REJECTED_TO_PARTNER_NOTIFY = "COMMISSION_L2_REJECTED_TO_PARTNER_NOTIFY",
}
...
function mapLegacyTypeToEmailType(legacyType: string): EmailType {
  const mapping: Record<string, EmailType> = {
    ...
    "Commission L1 Approved Notify": EmailType.COMMISSION_L1_APPROVED_NOTIFY,
    "Commission L1 Rejected Notify": EmailType.COMMISSION_L1_REJECTED_NOTIFY,
    "Commission L2 Approved Notify": EmailType.COMMISSION_L2_APPROVED_NOTIFY,
    "Commission L2 Rejected To L1 Notify":
      EmailType.COMMISSION_L2_REJECTED_TO_L1_NOTIFY,
    "Commission L2 Rejected To Partner Notify":
      EmailType.COMMISSION_L2_REJECTED_TO_PARTNER_NOTIFY,
  };
...
function inferCategoryFromType(emailType: EmailType): EmailCategory {
  const categoryMap: Record<EmailType, EmailCategory> = {
    ...
    [EmailType.COMMISSION_L1_APPROVED_NOTIFY]: EmailCategory.NOTIFICATION,
    [EmailType.COMMISSION_L1_REJECTED_NOTIFY]: EmailCategory.NOTIFICATION,
    [EmailType.COMMISSION_L2_APPROVED_NOTIFY]: EmailCategory.NOTIFICATION,
    [EmailType.COMMISSION_L2_REJECTED_TO_L1_NOTIFY]: EmailCategory.NOTIFICATION,
    [EmailType.COMMISSION_L2_REJECTED_TO_PARTNER_NOTIFY]:
