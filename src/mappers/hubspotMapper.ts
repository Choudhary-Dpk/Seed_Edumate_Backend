...
export class HubSpotMapper {
   ...
   */
  static mapEdumateContact(
    contact: HubSpotEdumateContact
  ): MappedEdumateContactEduToFrontend {
    const props = contact.properties;
    ...
    return {
      ...
      customProperties: this.extractCustomProperties(
        props,
        this.getStandardEdumateProperties()
      ),
    };
  }
  ...
  private static getStandardEdumateProperties(): string[] {
    return [
      ...
      "nationality",
      "current_address",
      "city__current_address_",
      "state__current_address_",
      "country__current_address_",
      "pincode__current_address_",
      "permanent_address",
      "city__permanent_address_",
      "state__permanent_address_",
      "country__permanent_address_",
      "pincode__permanent_address_",
  ...
  /**
   * Get list of all standard B2B Partner contact properties
   */
  private static getStandardB2BPartnerProperties(): string[] {
    return [
      "business_address",
      "business_type",
      "city",
