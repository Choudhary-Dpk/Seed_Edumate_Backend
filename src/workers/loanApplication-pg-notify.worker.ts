// // src/workers/loan-pg-notify.worker.ts
...
//     await loanPgClient.connect();
//     logger.info("[Loan PG NOTIFY] Connected to PostgreSQL");

//     await loanPgClient.query("LISTEN loan_sync_channel");
//     logger.info("[Loan PG NOTIFY] Listening on loan_sync_channel");

//     loanPgClient.on("notification", handleNotification);

//     loanPgClient.on("error", (err: any) => {
//       logger.error("[Loan PG NOTIFY] PostgreSQL connection error:", err);
//       reconnectPGClient();
//     });
...
//     logger.info(
//       `[Loan PG NOTIFY] Added loan application #${applicationId} to fallback queue`
//     );
//   } catch (error) {
//     logger.error("[Loan PG NOTIFY] Failed to add to fallback queue:", error);
//   }
// }
...
// async function reconnectPGClient() {
//   logger.warn("[Loan PG NOTIFY] Attempting to reconnect to PostgreSQL...");

//   try {
//     await loanPgClient.end();
//     await loanPgClient.connect();
//     await loanPgClient.query("LISTEN loan_sync_channel");
//     logger.info("[Loan PG NOTIFY] Reconnected to PostgreSQL");
//   } catch (error) {
//     logger.error("[Loan PG NOTIFY] Reconnection failed:", error);
//     setTimeout(reconnectPGClient, 5000);
//   }
// }
...
// REMOVED: const loanPgClient = new Client({ ... });
