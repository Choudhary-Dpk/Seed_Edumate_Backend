...
export const loanEligibilitySchema = z.object({
  ...
  analytical_exam_name: z.string().max(50, 'Analytical exam name must not exceed 50 characters').optional().nullable(),
  language_exam_name: z.string().max(50, 'Language exam name must not exceed 50 characters').optional().nullable(),
